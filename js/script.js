...
normal.onclick = () => {
    ...
    if (JSON.parse(localStorage.getItem('OperacionNormal')) == null) {
        ...
        document.body.appendChild(divNormal);
        divNormal.innerHTML = formHtml + '<p id="resultadoDos">El resultado de su ultima operacion fue:<br>' + JSON.parse(localStorage.getItem('OperacionNormal')) + '</p>';
    ...
    function funciónAlPresionarElBoton() {
        ...
        operacion.value == "+" ? resultado.innerHTML = lectura_de_numero1 + " + " + lectura_de_numero2 + " = " + (lectura_de_numero1 + lectura_de_numero2) :
        operacion.value == "-" ? resultado.innerHTML = lectura_de_numero1 + " - " + lectura_de_numero2 + " = " + (lectura_de_numero1 - lectura_de_numero2) :
        operacion.value == "x" ? resultado.innerHTML = lectura_de_numero1 + " x " + lectura_de_numero2 + " = " + (lectura_de_numero1 * lectura_de_numero2) :
        operacion.value == "/" ? resultado.innerHTML = lectura_de_numero1 + " / " + lectura_de_numero2 + " = " + (lectura_de_numero1 / lectura_de_numero2) :
...
fracciones.onclick = () => {
    ...
    if (JSON.parse(localStorage.getItem('OperacionFraccion')) == null) {
        ...
        document.body.appendChild(divFracciones);
        divFracciones.innerHTML = formHtml + '<p id="resultadoDos">El resultado de su ultima operacion fue:<br>' + JSON.parse(localStorage.getItem('OperacionFraccion')) + '</p>';
...
imc.onclick = () => {
    ...
    if (JSON.parse(localStorage.getItem('OperacionImc')) == null) {
        ...
        function funciónAlPresionarElBoton() {
            ...
            const promedio = (lectura_de_numero2 / (lectura_de_numero1 ** 2)).toFixed(2);

            const respuesta = new Promise((resolve, reject) => {
    
                if (promedio <= "24.9") {
    
                    resolve('Desde 18.5 a 24.9 se encuentra dentro del rango de peso normal o saludable. Menos de 18.4 se encuentra dentro del rango de peso insuficiente.');
    
                } else {
    
                    reject('Desde 25 en adelante se encuentra dentro del rango de sobrepeso.');
        ...
        document.body.appendChild(divImc);
        divImc.innerHTML = '<h1>Indice de Masa Corporal</h1><form><p>Debe de completar TODOS los campos requeridos.</p><p>Ingresar su peso corporal en kilogramos: <br><input type="number" id="numero2">kg<br>Ingresar su altura en metros: <br><input type="number" id="numero1">m</p><p class="resultado" id="resultado">Su IMC es de =</p><p id="resultadoPromedio"></p><p id="resultadoDos">El resultado de su ultimo IMC fue de:<br>' + JSON.parse(localStorage.getItem('OperacionImc')) + '</p><p><input type="button" value="calcular" id="botonCalcular"/><input type="reset" value="borrar" id="botonBorrar"/></p></form>';
