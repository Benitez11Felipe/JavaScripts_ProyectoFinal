...
normal.onclick = () => {
  ...
  const createForm = () => {
    return '<form><h1>Operaciones Matematicas Basicas</h1><p class="descripcion">Para poder realizar su operacion matematica debera ingresar en los cuadros de los costados su 1er y 2do valor, y en el cuadro del medio el signo del problema matematico que usted desea realizar. Si a la hora de apretar el boton calcular le aparece "NaN" es porque le falta agregar un valor a su operacion. Debe de completar TODOS los campos requeridos.</p><p><input type="number" id="numero1"/><select id="operacion"><option value="none">operacion</option><option value="+">+</option><option value="-">-</option><option value="x">x</option><option value="/">÷</option></select><input type="number" id="numero2"/></p><p class="resultado" id="resultado">Su resultado es: </p><p><input type="button" value="calcular" id="botonCalcular"/><input type="reset" value="borrar" id="botonBorrar"/></p></form>';
  };
  ...
  if (JSON.parse(localStorage.getItem("OperacionNormal")) == null) {
    ...
    divNormal.innerHTML = formHtml;
  } else {
    document.body.appendChild(divNormal);
    divNormal.innerHTML =
      formHtml +
      '<p id="resultadoDos">El resultado de su ultima operacion fue:<br>' +
      JSON.parse(localStorage.getItem("OperacionNormal")) +
      "</p>";
  }
  ...
  function funciónAlPresionarElBoton() {
    ...
    operacion.value == "+"
      ? (resultado.innerHTML =
          ...
          lectura_de_numero2 +
          " = " +
          (lectura_de_numero1 + lectura_de_numero2))
      : operacion.value == "-"
      ? (resultado.innerHTML =
          lectura_de_numero1 +
          " - " +
      ...
      : localStorage.setItem(
          "OperacionNormal",
          JSON.stringify(resultado.innerHTML)
        );
  }
};
...
fracciones.onclick = () => {
  ...
  if (JSON.parse(localStorage.getItem("OperacionFraccion")) == null) {
    ...
    divFracciones.innerHTML = formHtml;
  } else {
    document.body.appendChild(divFracciones);
    divFracciones.innerHTML =
      formHtml +
      '<p id="resultadoDos">El resultado de su ultima operacion fue:<br>' +
      JSON.parse(localStorage.getItem("OperacionFraccion")) +
      "</p>";
  }
  ...
  function funciónAlPresionarElBoton() {
    ...
    localStorage.setItem(
      "OperacionFraccion",
      JSON.stringify(resultadoFraccion.innerHTML)
    );
  }
};
...
mru.onclick = () => {
  ...
  velocidad.onclick = () => {
    ...
    divMruVelocidad.innerHTML =
      '<form><p>Ingresar el Espacio en metros: <br><input type="number" id="numero2">m <br>Ingresar el Tiempo en segundos: <br><input type="number" id="numero1">Seg</p><p class="resultado" id="resultado">Su resultado es =</p><p><input type="button" value="calcular" id="botonCalcular"/><input type="reset" value="borrar" id="botonBorrar"/></p></form>';
    ...
    function funciónAlPresionarElBoton() {
      ...
      resultado.innerHTML =
        "Velocidad = " +
        (lectura_de_numero2 / lectura_de_numero1).toFixed(2) +
        "m/s";
  ...
  espacio.onclick = () => {
    ...
    divMruEspacio.innerHTML =
      '<form><p>Ingresar la Velocidad en metros por segundos: <br><input type="number" id="numero2">m/s <br>Ingresar el Tiempo en segundos: <br><input type="number" id="numero1">seg</p><p class="resultado" id="resultado">Su resultado es =</p><p><input type="button" value="calcular" id="botonCalcular"/><input type="reset" value="borrar" id="botonBorrar"/></p></form>';
  ...
  tiempo.onclick = () => {
    ...
    divMruTiempo.innerHTML =
      '<form><p>Ingresar el Espacio en metros: <br><input type="number" id="numero2">m <br>Ingresar la Velocidad en metros por segundos: <br><input type="number" id="numero1">m/s</p><p class="resultado" id="resultado">Su resultado es =</p><p><input type="button" value="calcular" id="botonCalcular"/><input type="reset" value="borrar" id="botonBorrar"/></p></form>';
...
metrosCuadrados.onclick = () => {
  ...
  if (JSON.parse(localStorage.getItem("OperacionMetrosCuadrados")) == null) {
    ...
    document.body.appendChild(divMetrosCuadrados);
    divMetrosCuadrados.innerHTML =
      '<form><p>Debe de completar TODOS los campos requeridos.</p><p>Ingresar el Largo en metros: <br><input type="number" id="numero2">m <br>Ingresar el Ancho en metros: <br><input type="number" id="numero1">m</p><p class="resultado" id="resultado">Su resultado es =</p><p id="resultadoDos">El resultado de su ultima operacion fue: <br>' +
      JSON.parse(localStorage.getItem("OperacionMetrosCuadrados")) +
...
imc.onclick = () => {
  ...
  if (JSON.parse(localStorage.getItem("OperacionImc")) == null) {
    ...
    function funciónAlPresionarElBoton() {
      ...
      let imcResultado = (lectura_de_numero2 / lectura_de_numero1 ** 2).toFixed(
        2
      );
      ...
      const promedio = (lectura_de_numero2 / lectura_de_numero1 ** 2).toFixed(
        2
      );
      ...
      const respuesta = new Promise((resolve, reject) => {
        if (promedio <= "24.9") {
          resolve(
            "Desde 18.5 a 24.9 se encuentra dentro del rango de peso normal o saludable. Menos de 18.4 se encuentra dentro del rango de peso insuficiente."
          );
        } else {
          reject(
            "Desde 25 en adelante se encuentra dentro del rango de sobrepeso."
          );
        }
      });
      ...
      respuesta
        ...
        .then((res) => {
          resultadoPromedio.innerHTML = res;
        })

        .catch((error) => {
          resultadoPromedio.innerHTML = error;
        });
    }
  } else {
    document.body.appendChild(divImc);
    divImc.innerHTML =
      '<h1>Indice de Masa Corporal</h1><form><p>Debe de completar TODOS los campos requeridos.</p><p>Ingresar su peso corporal en kilogramos: <br><input type="number" id="numero2">kg<br>Ingresar su altura en metros: <br><input type="number" id="numero1">m</p><p class="resultado" id="resultado">Su IMC es de =</p><p id="resultadoPromedio"></p><p id="resultadoDos">El resultado de su ultimo IMC fue de:<br>' +
      JSON.parse(localStorage.getItem("OperacionImc")) +
      '</p><p><input type="button" value="calcular" id="botonCalcular"/><input type="reset" value="borrar" id="botonBorrar"/></p></form>';
    ...
    const numero1 = document.getElementById("numero1"),
      ...
      calcular = document.getElementById("botonCalcular"),
      resultado = document.getElementById("resultado"),
      resultadoPromedio = document.getElementById("resultadoPromedio");
