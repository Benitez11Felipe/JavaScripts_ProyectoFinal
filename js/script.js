...
normal.onclick = () => {
    ...
    divNormal.innerHTML = '<form><p class="descripcion">Para poder realizar su operacion matematica debera ingresar en el segundo cuadro (El cuadro del medio)<br>el signo del problema matematico que usted desea realizar: <br>(+ = Para Suma) (- = Para Resta) (x = para Multiplicacion) (/ = para Division)</p><p><input type="number"  id="numero1"/><select id="operacion"><option value="none">operacion</option><option value="+">+</option><option value="-">-</option><option value="x">x</option><option value="/">÷</option></select><input type="number"  id="numero2"/></p><p class="resultado" id="resultado">Su resultado es = </p><p><input type="button" value="calcular" id="botonCalcular"/><input type="reset" value="borrar" id="botonBorrar"/></p></form>'
